 ...
 // kiểm tra email/username trùng
    ...
    if ($exists->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            // Thiết lập các thông tin session giống như trong login.php
            $_SESSION["user_id"] = $new_user_id;
            $_SESSION["username"] = $username;
            $_SESSION["role"] = $role;
            $_SESSION["email"] = $email;
            // Chuyển hướng thẳng về index.php
            ...
            <div class="card">
                <div class="card-body p-5">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            <label for="phone" class="form-label">Số điện thoại <span style="color: #999;">(tùy
                                    chọn)</span></label>
                        ...
                        <div class="form-group">
                            <label for="address" class="form-label">Địa chỉ <span style="color: #999;">(tùy
                                    chọn)</span></label>
