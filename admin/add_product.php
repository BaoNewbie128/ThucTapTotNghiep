...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($brand === '' || $model === '' || $scale === '' || $color === '' || $description === '' || $price === false || $price < 0 || $stock === false || $stock < 0) {
        $error_message = "Dữ liệu sản phẩm không hợp lệ. Vui lòng kiểm tra lại các trường.";
    } else {
        try {
...
<a href="admin_dashboard.php?view=products" class="btn btn-secondary btn-sm mb-3">← Quay lại</a>
...
<div class="card p-4 shadow-sm" style="max-width: 700px;">
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label class="form-label fw-bold">Mẫu</label>
            <input type="text" name="model" class="form-control" required>
        </div>
        <div class="mb-3">
            <label class="form-label fw-bold">Tỉ lệ</label>
